...
ssh $CLOUD_USER@$CLOUD_IP "cd $CLOUD_PROJECT_PATH && nvcc cloud_gpu/upscale.cu -o upscaler -I/usr/local/include/opencv4 -L/usr/local/lib -lopencv_core -lopencv_imgcodecs -lopencv_imgproc -lopencv_highgui -std=c++11"
